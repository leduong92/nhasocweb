    ...
    return (
        <div className="container">
            ...
            <div className=" flex flex-col py-5 gap-5  md:flex-row lg:flex-row xl:grid xl:grid-cols-3">
                <Link href={`/refund`} className='flex flex-col border items-center shadow-md p-5 gap-3 xl:flex-row cursor-pointer hover:border-sky-500'>
                ...
                <Link href={`/shipping-policy`} className='flex flex-col border items-center shadow-md p-5 gap-3 xl:flex-row cursor-pointer hover:border-sky-500'>
                    <div className='flex items-center justify-center h-48 w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 xl:w-24 xl:h-24">
                ...
                <Link href={`/about-us`} className='flex flex-col border items-center shadow-md p-5 gap-3 xl:flex-row cursor-pointer hover:border-sky-500'>
                    <div className='flex items-center justify-center h-48 w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 xl:w-24 xl:h-24">
